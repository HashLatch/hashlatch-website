...
export const siteConfig = {
  brand: {
    ...
    fullName: "HashLatch",
    ticker: "HLC",
    tagline: "Latch the Value of Compute",
  },
  nav: {
    links: [
  ...
  tokenomics: {
    ...
    rows: [
      ...
      ["Block Reward", "10 HLC (halves every 4 years)"],
      ...
      ["Algorithm", "DGW-180 difficulty (adjusts every block)"],
    ] as [string, string][],
  },
  roadmap: {
    heading: "Roadmap",
    ...
    sections: {
      ...
      tokenomics: {
        ...
        rows: [
          ...
          ["First Halving", "Block 1,050,000 (~4 years)"],
          ["Consensus", "KawPow (GPU-only, ASIC-resistant)"],
          ["Difficulty", "DGW-180 (adjusts every block)"],
          ["Dev Fee", "2% of block reward (development, audits, infrastructure)"],
          ["Miner Reward", "98% of block emission"],
          ["Bounty Rewards", "User-funded escrow only. ZERO additional emission."],
      ...
      roadmap: {
        ...
        phases: [
          ...
          },
          {
            mark: "🔄",
            phase: "Phase 4",
            title: "DEX Listings & Exchange Integration",
            tone: "active" as const,
          },
          {
            mark: "•",
            phase: "Phase 5",
            title: "Cipherspace Explorer & Advanced Bounty Tools",
